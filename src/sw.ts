...
const versionStyles: string = "1.04";
const versionScripts: string  = "1.04";
const versionHtmls: string  = "1.04";
const versionFonts: string  = "1.04";
const versionImages: string  = "1.04";
